...
Board* QuadBoardDirector::build(){
  ...
  Board* board = builder
    ...
    ->setLedPort(13)
	  ->setFsrSenseRightHeelPort(31)
	  ->setFsrSenseRightToePort(32)
	  ->setFsrSenseLeftHeelPort(33)
	  ->setFsrSenseLeftToePort(34)
	  ->setTorqueSensorRightAnklePort(14)
	  ->setTorqueSensorRightKneePort(15)
	  ->setTorqueSensorLeftAnklePort(20)
	  ->setTorqueSensorLeftKneePort(19)
	  ...
	  ->setPotRightAnklePort(16)
	  ->setPotLeftAnklePort(35)
