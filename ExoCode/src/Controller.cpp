 ...
 */
 /*
void FranksCollinsHip::_update_spline_parameters(int mass, float peak_normalized_torque_Nm_kg, float ramp_start_percent_gait, float onset_percent_gait, float peak_percent_gait, float stop_percent_gait)
{
    // TODO: add config file read;
    // 1 cout << "\n exoBoot :: initCollinsProfile : Doing the init." << endl;
