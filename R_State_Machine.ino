void state_machine_RL() //For the comments on this file see the L_State_Machine
{
  switch (R_state)
  {
    case 1: //Swing
      ...
      else if ((R_p_steps->curr_voltage > fsr_percent_thresh_Right_Toe * fsr_Right_Toe_peak_ref)) //&& (fsr(fsr_sense_Long) < (fsr_thresh_long * fsr_cal_Long)))
      {
        state_count_RL_13++;
    ...
    case 3: //Late Stance
      ...
      if ((R_p_steps->curr_voltage < (fsr_percent_thresh_Right_Toe * fsr_Right_Toe_peak_ref)))
      {
        state_count_RL_31++;
