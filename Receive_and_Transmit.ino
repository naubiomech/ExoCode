...
void send_data_message_wc() //with COP
{
  ...
  // RIGHT
  bluetooth.print(exo->getRightAverageTorque());
  bluetooth.print(',');
  bluetooth.print(exo->getRightLegState());
  bluetooth.print(',');
  ...
  // LEFT
  bluetooth.print(exo->getLeftAverageTorque());
  bluetooth.print(',');
  bluetooth.print(exo->getLeftLegState());
  bluetooth.print(',');
