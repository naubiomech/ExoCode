...
#define FSR_SENSE_LEFT_TOE_PIN A2
#define FSR_SENSE_RIGHT_TOE_PIN A3

#define TORQUE_SENSOR_LEFT_ANKLE_PIN A0
#define TORQUE_SENSOR_RIGHT_ANKLE_PIN A6
...
#define MOTOR_ERROR_LEFT_ANKLE_PIN 4
#define MOTOR_ERROR_RIGHT_ANKLE_PIN 11

#define MOTOR_CURRENT_LEFT_ANKLE_PIN A7 
#define MOTOR_CURRENT_RIGHT_ANKLE_PIN A1 

#define PWR_SCL A5 //SCL
#define PWR_SDA A4 //SDA
#endif
