...
const unsigned int MOTOR_LEFT_ANKLE_PIN = 10; //PWM 3
const unsigned int MOTOR_RIGHT_ANKLE_PIN = 3; //PWM 10
...
const unsigned int MOTOR_ERROR_LEFT_ANKLE_PIN = 2; //4
const unsigned int MOTOR_ERROR_RIGHT_ANKLE_PIN = 4; //2

const unsigned int MOTOR_CURRENT_LEFT_ANKLE_PIN = A1; //A7
const unsigned int MOTOR_CURRENT_RIGHT_ANKLE_PIN = A7; //A1
