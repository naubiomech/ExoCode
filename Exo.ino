...
//    Serial.print("left leg target");
//    Serial.println(left_leg->stridelength_target);
//    Serial.print("left leg baseline");
//    Serial.println(left_leg->stridelength_baseline);
//    Serial.print("Heel strike");
//    Serial.println(left_leg->Heel_Strike_Count);
//    Serial.print("Score");
//    Serial.println(left_leg->score);
