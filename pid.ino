...
void pid(Leg* leg, double input) {
  ...
  if (CURRENT_CONTROL && leg->PID_Setpoint!=0) {
    leg->Vol = (leg->PID_Setpoint/((13.6/1000.0) * 51.0 * (70.4/10.3) * 0.89 * 0.70 * 0.50))/7.58*2048; //Setpoint/(Motor torque constant, gear reduction, pulley reduction, motor eff, gearbox eff)
  } else {
